...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-gradient-to-b from-zinc-900/60 to-black/80 backdrop-blur-2xl border-b border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_6px_24px_rgba(0,0,0,0.25)]">
