...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-gradient-to-b from-zinc-950 to-black border-b border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_6px_24px_rgba(0,0,0,0.25)]">
