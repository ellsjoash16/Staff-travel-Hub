  ...
  return (
    <>
      ...
      >
        {/* ── Logo ── */}
        <div
          className={`flex-shrink-0 flex items-center h-14 sm:h-16 2xl:h-20 overflow-hidden border-b border-white/10 bg-gradient-to-b from-zinc-950 to-black shadow-[0_6px_24px_rgba(0,0,0,0.25)] ${expanded ? 'px-4' : 'justify-center'}`}
        >
          <button
            type="button"
            onClick={() => go('home')}
