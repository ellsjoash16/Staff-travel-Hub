  ...
  return (
    <>
      ...
      >
        {/* ── Logo ── */}
        <div
          className={`flex-shrink-0 flex items-center h-14 sm:h-16 2xl:h-20 overflow-hidden border-b border-white/10 bg-gradient-to-b from-zinc-950/90 to-black/95 backdrop-blur-2xl shadow-[inset_0_1px_0_rgba(255,255,255,0.18)] ${expanded ? 'px-4' : 'justify-center'}`}
        >
          <button
            type="button"
            onClick={() => go('home')}
