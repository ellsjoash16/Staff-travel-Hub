    ...
    <div className="relative h-full overflow-auto">
      ...
      <div className="relative flex flex-col px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 py-5 lg:py-6 xl:py-8" style={{ zIndex: 1 }}>
        ...
        <div className="w-full mb-6">
          <h2 className="font-gilbert text-3xl xl:text-4xl text-white leading-tight drop-shadow mb-3">
            {tab === 'trips' ? 'Upcoming Trips' : 'Events'}
          </h2>
          <div className="flex gap-1 bg-white/10 backdrop-blur-sm rounded-xl p-1 w-fit">
            <button
